        ...
        <>
            {/* <Slider {...settings}>
                    <div className='rounded'>
                        <img className='relative rounded object-cover h-[400px] md:h-[600px] ' style={{ width: '100%' }} src={banner1} />
                    ...
                    <div className='rounded'>
                        <img className='relative rounded object-cover h-[400px] md:h-[600px] ' style={{ width: '100%' }} src={banner3} />
            ...
            <div className="slide-container rounded">
                <Fade>
                    ...
                    <div className='rounded'>
                        <img className='relative object-cover rounded h-[400px] md:h-[600px] ' style={{ width: '100%' }} src={banner2} />
                    ...
                    <div className='rounded'>
                        <img className='relative object-cover rounded h-[400px] md:h-[600px] ' style={{ width: '100%' }} src={banner4} />
